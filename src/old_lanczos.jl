...
function old_Lanczos(dim, norbs, nalpha, nbeta, H_alpha, H_beta, Ia, Ib, alpha_configs, beta_configs, int2e, index_table_a, index_table_b, ndets_a, sign_table_a, sign_table_b, max_iter::Int=12, ϑ::Float64=1e-8)
